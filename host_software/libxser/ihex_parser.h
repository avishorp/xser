...
public:
	...
	ihex_error(ihex_error& e) : description(e.description) {
...
typedef ihex_error error_t;
typedef std::list<error_t> error_list_t;
typedef error_list_t::const_iterator error_const_iter_t;
